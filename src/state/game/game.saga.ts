...
const setGameData = async (client: Apollo.Entity, game: Game.Entity) => {
...
const getGamesPlayersData = async (client: Apollo.Entity, gameId: string) => {
...
const deleteGamesPlayersData = async (
...
const setGamesPlayersData = async (
  client: Apollo.Entity,
  playerId: string,
  gameId: string,
